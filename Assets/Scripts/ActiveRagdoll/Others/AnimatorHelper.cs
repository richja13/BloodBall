    ...
    public class AnimatorHelper : MonoBehaviour {
        ...
        private void UpdateIKTransitions() {
            if (SmoothIKTransitions) {
                ...
                _currentRightArmIKWeight = Mathf.Lerp(_currentRightArmIKWeight, RightArmIKWeight, Time.deltaTime * IKTransitionsSpeed *40);
        ...
        private void OnAnimatorIK(int layerIndex) {
            ...
            _animator.SetIKHintPositionWeight(AvatarIKHint.RightElbow, RightArmIKWeight/2);
            ...
            _animator.SetIKHintPosition(AvatarIKHint.RightElbow, RightHandHint.position/2);
