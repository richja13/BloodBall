...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    private CustomBloomEffect m_stylEffect;
    ...
    public CustomPostProcessPass(Material bloomMaterial, Material stylizedMaterial)
    {
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        m_stylEffect = stack.GetComponent<CustomBloomEffect>();
